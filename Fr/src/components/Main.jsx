  ...
  return (
    <div className='w-full h-[800px] text-white'>
        ...
        <div className='absolute w-full top-[20%] p-4 md:p-8'>
            ...
            <div className='my-4'>
                <button className='border bg-gray-300 text-black border-gray-300 py-2 px-5'>Zobacz Recenzje</button>
                <button className='border  text-white border-gray-300 py-2 px-5 ml-4'>Obejrzyj Trailer</button>
            </div>
